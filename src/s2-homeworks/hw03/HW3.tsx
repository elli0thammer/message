...
export const pureAddUserCallback = (name: string, setUsers: (user1: Array<UserType>)=>void, users: Array<UserType>) => { // need to fix any
...
const HW3 = () => {
    const [users, setUsers] = useState<Array<UserType>>([]) // need to fix any функция которая хранит юзеров

    const addUserCallback = (name: string) => { // need to fix any функция которая добавляет юзеров
